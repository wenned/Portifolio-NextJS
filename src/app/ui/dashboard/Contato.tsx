    ...
    return(
        <div itemID='Contato' className="flex w-screen max-sm:flex-col overflow-hidden" id="Contato">
             ...
             <div className='flex p-7 w-screen justify-around items-center border-r-2 border-white'>
                <span className='max-lg:text-2xl cursor-pointer'><FaLinkedinIn string="Linkdin" onClick={FaLink}/></span>
                <span className='max-lg:text-2xl cursor-pointer'><VscGithub string="GitHub" onClick={FaGit}/></span>
                <span className='max-lg:text-2xl cursor-pointer'><FaXTwitter  string="Twitter" onClick={FaTw}/></span>
            </div>         
